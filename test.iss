...
[CODE]
#define GDIDLLPATH "E:\Cpp\Projects\Build\build-isGDIp\build-isGDIp-Qt_5_12_1_msvc2017-Release\isGDI2.dll"
...
begin
  ...
  CircleId := DrawCircle(WizardForm.WelcomePage.Handle,Color2(255,clRed),36,36,100,100,0,0);
  ArcId := DrawArc(WizardForm.WelcomePage.Handle,Color2(160,clgreen),36,140,100,100,0,0,10);
